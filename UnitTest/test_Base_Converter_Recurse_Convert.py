...
class MyTestCase(unittest.TestCase):
    ...
    def test_54_to_base10_standard(self):
        ...
        self.assertEqual(["5", "4"], self.converter.recuse_convert(54))
    ...
    def test_54_to_base100_unicode(self):
        ...
        self.assertEqual(["U", "+", "0", "0", "0", "0", "U", "+", "0", "0", "3", "6"], self.converter.recuse_convert(54))
    ...
    def test_54_to_base100_ascii(self):
        ...
        self.assertEqual(["\x00", "A"], self.converter.recuse_convert(65))
